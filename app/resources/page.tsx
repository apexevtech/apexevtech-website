...
export const metadata: Metadata = buildPageMetadata({ title: "EV Charging Test Resources", description: "Practical guides for selecting, configuring and using EV charger testing equipment.", path: "/resources" });
